var PlatformBrowser = (function () {
  ...
  function htmlStore(provider) {

      return {

          async get(key) {
              const value = provider.getItem(key);
              return isString_1(value) ? JSON.parse(value) : value;
          },
  ...
  function localStore$1() {
    var provider = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : localStorage;
  ...
  function sessionStore$1() {
    var provider = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : sessionStorage;
    return htmlStore(provider);
  }
  /**
   * @global
  ...
  function promisify$1(object, success, error) {
    return new Promise(function (resolve, reject) {
      object[error] = reject;
  ...
  function indexedDB$1(_ref) {
    var _ref$database = _ref.database,
        database = _ref$database === void 0 ? '@paychex' : _ref$database,
        _ref$version = _ref.version,
        version = _ref$version === void 0 ? 1 : _ref$version,
        store = _ref.store;
    var databases = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : dbs$1;
    var dbVersion = 1;
    var prefix = "".concat(store, "@");
    var table = "".concat(prefix).concat(version);
    ...
    function isLowerVersion(storeName) {
      return storeName.startsWith(prefix) && Number(storeName.replace(prefix, '')) < version;
    }
    ...
    function openDatabase() {
      return new Promise(function (resolve, reject) {
        var request = window.indexedDB.open(database, dbVersion);
        request.onupgradeneeded = createStore;
        promisify$1(request, 'onsuccess', 'onerror').then(handleVersionChange, handleOpenError).then(resolve, reject);
      });
    }
    ...
    function createStore(e) {
      ...
      Array.prototype.filter.call(stores, isLowerVersion).forEach(db.deleteObjectStore, db);
    }
    ...
    function performOperation(_x, _x2) {
      return _performOperation.apply(this, arguments);
    }

    function _performOperation() {
      _performOperation = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(operation, args) {
        var mode,
            db,
            tx,
            os,
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                mode = _args4.length > 2 && _args4[2] !== undefined ? _args4[2] : 'readonly';
                _context4.next = 3;
                return ready;

              case 3:
                db = databases.get(database);
                tx = db.transaction(table, mode);
                os = tx.objectStore(table);
                req = os[operation].apply(os, args);
    ...
    var ready = openDatabase().then(upgradeIfStoreNotFound);
    return {
      get: function get(key) {
          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  return _context.abrupt("return", performOperation('get', [key]));
          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  return _context2.abrupt("return", performOperation('put', [value, key], 'readwrite'));
          ...
          return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  return _context3.abrupt("return", performOperation('delete', [key], 'readwrite'));
  ...
  if (_descriptors && (!CORRECT_NEW || _fails(function () {
    ...
    for (var keys$1 = gOPN$1(Base$1), i$2 = 0; keys$1.length > i$2;) proxy(keys$1[i$2++]);
   ...
   * }
   */
  const rethrow = curry_1(function throwWithProps() {
      const error = Array.prototype.find.call(arguments, isError_1);
      const data = Array.prototype.find.call(arguments, isPlainObject_1);
   ...
   * }
   */
  function eventBus(context, mode = parallel) {
   ...
   */
  const parallel = getInvocationPattern(function invoker(methods, args) {
   ...
   * }
   */
  function manualReset(signaled = false) {
  ...
  function toTransferable(thing) {
    var string = JSON.stringify(thing);
    if (typeof string !== 'string') throw error('Message arguments must be serializable as JSON.', fatal());
    return new Blob(string.split('')).arrayBuffer();
  }

  function toTransferables(_x) {
    return _toTransferables.apply(this, arguments);
  }

  function _toTransferables() {
    _toTransferables = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(args) {
      var promises;
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              promises = args.map(toTransferable);
              _context4.next = 3;
  ...
  function fromTransferable(_x2) {
    return _fromTransferable.apply(this, arguments);
  }

  function _fromTransferable() {
    _fromTransferable = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(buffer) {
      var array, json;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 3;
              return new Blob([array]).text();

            case 3:
              json = _context5.sent;
              return _context5.abrupt("return", JSON.parse(json));
  ...
  function fromTransferables(_x3) {
    return _fromTransferables.apply(this, arguments);
  }

  function _fromTransferables() {
    _fromTransferables = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(objects) {
      var promises;
      return regeneratorRuntime.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              promises = objects.map(fromTransferable);
              _context6.next = 3;
              return Promise.all(promises);
  ...
  function toEnvelope(_x4) {
    return _toEnvelope.apply(this, arguments);
  }

  function _toEnvelope() {
    _toEnvelope = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(message) {
      var _len,
          args,
          _key,
          transfers,
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 4;
              return toTransferables(args);

            case 4:
              transfers = _context7.sent;
  ...
  function fromEnvelope(_x5) {
    return _fromEnvelope.apply(this, arguments);
  }

  function _fromEnvelope() {
    _fromEnvelope = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(data) {
      var message, transfers, args, origin;
      return regeneratorRuntime.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              message = data.message, transfers = data.transfers;
              _context8.next = 3;
              return fromTransferables(transfers);
  ...
  function sendMessageResponse(_x6, _x7) {
    return _sendMessageResponse.apply(this, arguments);
  }

  function _sendMessageResponse() {
    _sendMessageResponse = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(status, result) {
      var envelope;
      return regeneratorRuntime.wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            ...
            case 6:
              _context9.next = 8;
              return toEnvelope(status, result);

            case 8:
              _context9.t0 = _context9.sent;

            case 9:
              envelope = _context9.t0;
  ...
  function handleMessageResponse(_x8) {
    return _handleMessageResponse.apply(this, arguments);
  }

  function _handleMessageResponse() {
    _handleMessageResponse = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(e) {
      var _yield$fromEnvelope2, message, args;
      ...
      return regeneratorRuntime.wrap(function _callee10$(_context10) {
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              _context10.next = 2;
              return fromEnvelope(e.data);

            case 2:
              _yield$fromEnvelope2 = _context10.sent;
              message = _yield$fromEnvelope2.message;
              args = _yield$fromEnvelope2.args;
              message === 'success' ? this.resolve(args[0]) : this.reject(args[0]);
  ...
  function crossOriginEventBus() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        _ref$key = _ref.key,
        key = _ref$key === void 0 ? '' : _ref$key,
        _ref$url = _ref.url,
        url = _ref$url === void 0 ? null : _ref$url,
        _ref$origins = _ref.origins,
        origins = _ref$origins === void 0 ? ['*'] : _ref$origins;

    function SendMessagePromise(resolve, reject) {
      var transfers = [this.channel.port2].concat(this.envelope.transfers);
      var messageHandler = handleMessageResponse.bind({
        resolve: resolve,
        reject: reject
      });
    ...
    function _fire() {
      _fire = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(message) {
        var channel,
            _len2,
            args,
            _key2,
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                _context.next = 6;
                return toEnvelope.apply(void 0, [message].concat(args));

              case 6:
                envelope = _context.sent;
                return _context.abrupt("return", new Promise(SendMessagePromise.bind({
                  channel: channel,
                  envelope: envelope
                })));
    ...
    function receiveMessage(_x10) {
      return _receiveMessage.apply(this, arguments);
    }

    function _receiveMessage() {
      _receiveMessage = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
        var _yield$fromEnvelope, message, args, origin;
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                _yield$fromEnvelope = _context2.sent;
                message = _yield$fromEnvelope.message;
                args = _yield$fromEnvelope.args;
                origin = _yield$fromEnvelope.origin;
                ...
                _context2.next = 11;
                return bus.fire.apply(bus, [message].concat(_toConsumableArray(args))).then(sendMessageResponse.bind(e.ports[0], 'success'), sendMessageResponse.bind(e.ports[0], 'failure'));
    ...
    function connectChild(_x11) {
      return _connectChild.apply(this, arguments);
    }

    function _connectChild() {
      _connectChild = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
    ...
    var port, frame;
    var bus = eventBus();
    var signal = manualReset(false);
    var CONNECT = "connect:".concat(key);
    var allowed = origins.map(asRegExp);

    var verify = function verify(origin) {
      return allowed.some(matches, origin);
    };
    ...
    return _objectSpread2(_objectSpread2({}, bus), {}, {
      fire: fire,
      dispose: dispose
    });
  }

  var index = _objectSpread2(_objectSpread2({}, stores), {}, {
    eventBus: crossOriginEventBus
  });
